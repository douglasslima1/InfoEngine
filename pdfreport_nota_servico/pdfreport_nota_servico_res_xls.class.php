...
class pdfreport_nota_servico_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function pdfreport_nota_servico_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "pdfreport_nota_servico.xls";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['xls_name']);
      }
      ...
      $this->Res       = new pdfreport_nota_servico_resumo("out");
   ...
   function grava_arquivo()
   {
      ...
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['pivot_tabular'];
      if (1 >= sizeof($this->comp_y_axys))
      {
          $this->comp_tabular = false;
      }
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_nota_servico']['xls_file'] = $this->Xls_f;
      }
