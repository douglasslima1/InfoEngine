  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_modelos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_tbl_modelos_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldText(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_modelos_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_tbl_modelos_validate_id__cb);
  } // do_ajax_form_tbl_modelos_validate_id_

  function do_ajax_form_tbl_modelos_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_modelos_validate_id__cb

  // ---------- Validate modelo_
  function do_ajax_form_tbl_modelos_validate_modelo_(iNumLinha)
  {
    var nomeCampo_modelo_ = "modelo_" + iNumLinha;
    var var_modelo_ = scAjaxGetFieldText(nomeCampo_modelo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_modelos_validate_modelo_(var_modelo_, iNumLinha, var_script_case_init, do_ajax_form_tbl_modelos_validate_modelo__cb);
  } // do_ajax_form_tbl_modelos_validate_modelo_

  function do_ajax_form_tbl_modelos_validate_modelo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "modelo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "modelo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "modelo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "modelo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_modelos_validate_modelo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tbl_modelos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tbl_modelos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tbl_modelos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tbl_modelos_add_new_line_cb);
  } // do_ajax_form_tbl_modelos_add_new_line

  function do_ajax_form_tbl_modelos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tbl_modelos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tbl_modelos_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_modelos_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tbl_modelos_backup_line_cb);
  } // do_ajax_form_tbl_modelos_backup_line

  function do_ajax_form_tbl_modelos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_tbl_modelos_backup_line_cb

  function do_ajax_form_tbl_modelos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tbl_modelos_cancel_insert

  function do_ajax_form_tbl_modelos_cancel_update(iSeqVert)
  {
    do_ajax_form_tbl_modelos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tbl_modelos_cancel_update

  function do_ajax_form_tbl_modelos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tbl_modelos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tbl_modelos_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_modelos_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_modelos_table_refresh_cb);
  } //  do_ajax_form_tbl_modelos_table_refresh

  function do_ajax_form_tbl_modelos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_tbl_modelos_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tbl_modelos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tbl_modelos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldText("id_" + iNumLinha);
    var var_modelo_ = scAjaxGetFieldText("modelo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tbl_modelos_submit_form(var_id_, var_modelo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_modelos_submit_form_cb);
  } // do_ajax_form_tbl_modelos_submit_form

  function do_ajax_form_tbl_modelos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("modelo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_tbl_modelos_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tbl_modelos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tbl_modelos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("modelo_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tbl_modelos_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_modelos_navigate_form_cb);
  } // do_ajax_form_tbl_modelos_navigate_form

  function do_ajax_form_tbl_modelos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_tbl_modelos_navigate_form_cb
  function sc_hide_form_tbl_modelos_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tbl_modelos_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "modelo_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["modelo_" + iNumLinha] = {"label": "Modelo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["modelo_"][iNumLinha] = "modelo_" + iNumLinha;
    ajax_field_id["id_" + iNumLinha] = new Array("hidden_field_label_id_", "hidden_field_data_id_" + iNumLinha);
    ajax_field_id["modelo_" + iNumLinha] = new Array("hidden_field_label_modelo_", "hidden_field_data_modelo_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["modelo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["modelo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["modelo_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["modelo_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["modelo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["modelo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["modelo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["modelo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["modelo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['modelo_'])) ? $this->nmgp_cmp_readonly['modelo_'] : 'off';
?>
    scAjaxFieldRead("modelo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("modelo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["modelo_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_modelo_" + iRow))
        document.getElementById("hidden_field_data_modelo_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["modelo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["modelo_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_modelo_" + iRow))
        document.getElementById("hidden_field_data_modelo_" + iRow).className = sCssLine;
    }
  }
