...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("dashboard_inicial") . "/dashboard_inicial_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_inicial']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['dashboard_inicial'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tbl_marcas") . "/grid_tbl_marcas_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_marcas']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_ordem_servico") . "/grid_ordem_servico_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_ordem_servico_totalizacao") . "/grid_ordem_servico_totalizacao_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico_totalizacao']))
    {
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("chart_ordem_servico") . "/chart_ordem_servico_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_ordem_servico']))
    {
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[4]))
{
 ...
 $nm_var_lab[5] = "Ordens de Serviço";
...
$menu_principal_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "|scriptcase__NM__ico__NM__gear_24.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_marcas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_marcas']) == "on")
{
    $menu_principal_menuData['data'] .= "item_5|..|" . $nm_var_lab[1] . "|menu_principal_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_tbl_marcas&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_5|..|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
$menu_principal_menuData['data'] .= "item_2|.|" . $nm_var_lab[2] . "||" . $nm_var_hint[2] . "|scriptcase__NM__ico__NM__user_earth_24.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) == "on")
{
    $menu_principal_menuData['data'] .= "item_6|..|" . $nm_var_lab[3] . "|menu_principal_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_cliente&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_6|..|" . $nm_var_lab[3] . "||||_self|disabled\n";
}
$menu_principal_menuData['data'] .= "item_3|.|" . $nm_var_lab[4] . "||" . $nm_var_hint[4] . "|scriptcase__NM__ico__NM__worker_24.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico']) == "on")
{
    $menu_principal_menuData['data'] .= "item_7|..|" . $nm_var_lab[5] . "|menu_principal_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_ordem_servico&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_7|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
$menu_principal_menuData['data'] .= "item_4|.|" . $nm_var_lab[6] . "||" . $nm_var_hint[6] . "|scriptcase__NM__ico__NM__book_blue_open_24.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico_totalizacao']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico_totalizacao']) == "on")
{
    $menu_principal_menuData['data'] .= "item_8|..|" . $nm_var_lab[7] . "|menu_principal_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_ordem_servico_totalizacao&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_8|..|" . $nm_var_lab[7] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['chart_ordem_servico']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['chart_ordem_servico']) == "on")
{
    $menu_principal_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "|menu_principal_form_php.php?sc_item_menu=item_9&sc_apl_menu=chart_ordem_servico&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_9|..|" . $nm_var_lab[8] . "||||_self|disabled\n";
}
$menu_principal_menuData['data'] .= "item_10|.|" . $this->Nm_lang['lang_menu_security'] . "||" . $this->Nm_lang['lang_menu_security'] . "|scriptcase__NM__ico__NM__lock_ok_24.png|_self|\n";
...
{
    $menu_principal_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_list_users'] . "|menu_principal_form_php.php?sc_item_menu=item_11&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_users'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_11|..|" . $this->Nm_lang['lang_list_users'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) == "on")
{
    $menu_principal_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_list_apps'] . "|menu_principal_form_php.php?sc_item_menu=item_12&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_12|..|" . $this->Nm_lang['lang_list_apps'] . "||||_self|disabled\n";
}
...
{
    $menu_principal_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_list_groups'] . "|menu_principal_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_groups'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_13|..|" . $this->Nm_lang['lang_list_groups'] . "||||_self|disabled\n";
}
...
{
    $menu_principal_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "|menu_principal_form_php.php?sc_item_menu=item_14&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_14|..|" . $this->Nm_lang['lang_list_apps_x_groups'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) == "on")
{
    $menu_principal_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_list_sync_apps'] . "|menu_principal_form_php.php?sc_item_menu=item_15&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_list_sync_apps'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_15|..|" . $this->Nm_lang['lang_list_sync_apps'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) == "on")
{
    $menu_principal_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_change_pswd'] . "|menu_principal_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_change_pswd'] . "||" . $this->menu_principal_target('_self') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_16|..|" . $this->Nm_lang['lang_change_pswd'] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) == "on")
{
    $menu_principal_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_exit'] . "|menu_principal_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "|" . $this->Nm_lang['lang_exit'] . "||" . $this->menu_principal_target('_parent') . "|" . "\n";
}
else
{
    $menu_principal_menuData['data'] .= "item_17|..|" . $this->Nm_lang['lang_exit'] . "||||_parent|disabled\n";
}
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_5&sc_apl_menu=grid_tbl_marcas&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_marcas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_marcas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "scriptcase__NM__ico__NM__user_earth_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_cliente&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cliente']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "scriptcase__NM__ico__NM__worker_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_7&sc_apl_menu=grid_ordem_servico&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "scriptcase__NM__ico__NM__book_blue_open_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_8&sc_apl_menu=grid_ordem_servico_totalizacao&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico_totalizacao']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ordem_servico_totalizacao']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_9&sc_apl_menu=chart_ordem_servico&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['chart_ordem_servico']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['chart_ordem_servico']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "#";
$str_icon = "scriptcase__NM__ico__NM__lock_ok_24.png";
$icon_aba = "";
$icon_aba_inactive = "";
if(empty($icon_aba) && isset($arr_menuicons['others']['active']))
{
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_11&sc_apl_menu=app_grid_sec_users&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_12&sc_apl_menu=app_grid_sec_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_13&sc_apl_menu=app_grid_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_14&sc_apl_menu=app_search_sec_groups&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_15&sc_apl_menu=app_sync_apps&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_16&sc_apl_menu=app_change_pswd&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_principal_form_php.php?sc_item_menu=item_17&sc_apl_menu=app_Login&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['app_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['dashboard_inicial']) && $_SESSION['scriptcase']['sc_apl_seg']['dashboard_inicial'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_principal');\" item-href=\"menu_principal_form_php.php?sc_item_menu=menu_principal&sc_apl_menu=dashboard_inicial&sc_apl_link=" . urlencode($menu_principal_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_principal']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_principal_iframe\"";
} 
else
{ 
