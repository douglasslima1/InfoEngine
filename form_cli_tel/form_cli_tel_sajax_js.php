  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cli_tel" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_cli_tel_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_id__cb);
  } // do_ajax_form_cli_tel_validate_id_

  function do_ajax_form_cli_tel_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_id__cb

  // ---------- Validate idcliente_
  function do_ajax_form_cli_tel_validate_idcliente_(iNumLinha)
  {
    var nomeCampo_idcliente_ = "idcliente_" + iNumLinha;
    var var_idcliente_ = scAjaxGetFieldSelect(nomeCampo_idcliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_idcliente_(var_idcliente_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_idcliente__cb);
  } // do_ajax_form_cli_tel_validate_idcliente_

  function do_ajax_form_cli_tel_validate_idcliente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_idcliente__cb

  // ---------- Validate ordem_
  function do_ajax_form_cli_tel_validate_ordem_(iNumLinha)
  {
    var nomeCampo_ordem_ = "ordem_" + iNumLinha;
    var var_ordem_ = scAjaxGetFieldText(nomeCampo_ordem_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_ordem_(var_ordem_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_ordem__cb);
  } // do_ajax_form_cli_tel_validate_ordem_

  function do_ajax_form_cli_tel_validate_ordem__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ordem_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ordem_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ordem_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ordem_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_ordem__cb

  // ---------- Validate tipo_
  function do_ajax_form_cli_tel_validate_tipo_(iNumLinha)
  {
    var nomeCampo_tipo_ = "tipo_" + iNumLinha;
    var var_tipo_ = scAjaxGetFieldSelect(nomeCampo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_tipo_(var_tipo_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_tipo__cb);
  } // do_ajax_form_cli_tel_validate_tipo_

  function do_ajax_form_cli_tel_validate_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_tipo__cb

  // ---------- Validate ddd_
  function do_ajax_form_cli_tel_validate_ddd_(iNumLinha)
  {
    var nomeCampo_ddd_ = "ddd_" + iNumLinha;
    var var_ddd_ = scAjaxGetFieldText(nomeCampo_ddd_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_ddd_(var_ddd_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_ddd__cb);
  } // do_ajax_form_cli_tel_validate_ddd_

  function do_ajax_form_cli_tel_validate_ddd__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ddd_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ddd_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ddd_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ddd_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_ddd__cb

  // ---------- Validate numero_
  function do_ajax_form_cli_tel_validate_numero_(iNumLinha)
  {
    var nomeCampo_numero_ = "numero_" + iNumLinha;
    var var_numero_ = scAjaxGetFieldText(nomeCampo_numero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_numero_(var_numero_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_numero__cb);
  } // do_ajax_form_cli_tel_validate_numero_

  function do_ajax_form_cli_tel_validate_numero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_numero__cb

  // ---------- Validate obs_
  function do_ajax_form_cli_tel_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_cli_tel_validate_obs__cb);
  } // do_ajax_form_cli_tel_validate_obs_

  function do_ajax_form_cli_tel_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_tel_validate_obs__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cli_tel_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cli_tel_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cli_tel_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cli_tel_add_new_line_cb);
  } // do_ajax_form_cli_tel_add_new_line

  function do_ajax_form_cli_tel_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_cli_tel_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cli_tel_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_tel_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cli_tel_backup_line_cb);
  } // do_ajax_form_cli_tel_backup_line

  function do_ajax_form_cli_tel_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_cli_tel_backup_line_cb

  function do_ajax_form_cli_tel_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cli_tel_cancel_insert

  function do_ajax_form_cli_tel_cancel_update(iSeqVert)
  {
    do_ajax_form_cli_tel_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cli_tel_cancel_update

  function do_ajax_form_cli_tel_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cli_tel_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cli_tel_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_cli_tel_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cli_tel_table_refresh_cb);
  } //  do_ajax_form_cli_tel_table_refresh

  function do_ajax_form_cli_tel_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_cli_tel_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cli_tel_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cli_tel_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_ordem_ = scAjaxGetFieldText("ordem_" + iNumLinha);
    var var_tipo_ = scAjaxGetFieldSelect("tipo_" + iNumLinha);
    var var_ddd_ = scAjaxGetFieldText("ddd_" + iNumLinha);
...
?>
    x_ajax_form_cli_tel_submit_form(var_id_, var_idcliente_, var_ordem_, var_tipo_, var_ddd_, var_numero_, var_obs_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cli_tel_submit_form_cb);
  } // do_ajax_form_cli_tel_submit_form

  function do_ajax_form_cli_tel_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("ordem_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tipo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ddd_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_cli_tel_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cli_tel_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cli_tel_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("ordem_" + iNavForm);
      scAjaxHideErrorDisplay("tipo_" + iNavForm);
      scAjaxHideErrorDisplay("ddd_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cli_tel_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cli_tel_navigate_form_cb);
  } // do_ajax_form_cli_tel_navigate_form

  function do_ajax_form_cli_tel_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_cli_tel_navigate_form_cb
  function sc_hide_form_cli_tel_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_cli_tel_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ordem_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ddd_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["ordem_" + iNumLinha] = {"label": "Ordem<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["ddd_" + iNumLinha] = {"label": "DDD<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["numero_" + iNumLinha] = {"label": "Número<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["ordem_"][iNumLinha] = "ordem_" + iNumLinha;
    ajax_field_mult["tipo_"][iNumLinha] = "tipo_" + iNumLinha;
    ajax_field_mult["ddd_"][iNumLinha] = "ddd_" + iNumLinha;
    ...
    ajax_field_id["ddd_" + iNumLinha] = new Array("hidden_field_label_ddd_", "hidden_field_data_ddd_" + iNumLinha);
    ...
    ajax_error_count["ordem_" + iNumLinha] = "off";
    ajax_error_count["tipo_" + iNumLinha] = "off";
    ajax_error_count["ddd_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ordem_" + iNumLinha] = "off";
    ajax_read_only["tipo_" + iNumLinha] = "off";
    ajax_read_only["ddd_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["ordem_" + iNumLinha] = "on";
    ajax_read_only["tipo_" + iNumLinha] = "on";
    ajax_read_only["ddd_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["ordem_" + iNumLinha] = null;
    ajax_error_list["tipo_" + iNumLinha] = null;
    ajax_error_list["ddd_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["ordem_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ordem_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ordem_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ordem_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ordem_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["ddd_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ddd_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ddd_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ddd_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ddd_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ordem_'])) ? $this->nmgp_cmp_readonly['ordem_'] : 'off';
?>
    scAjaxFieldRead("ordem_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ddd_'])) ? $this->nmgp_cmp_readonly['ddd_'] : 'off';
?>
    scAjaxFieldRead("ddd_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("ordem_" + iSeq, "on");
    scAjaxFieldRead("tipo_" + iSeq, "on");
    scAjaxFieldRead("ddd_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["idcliente_" + iRow] || "on" == ajax_error_count["ordem_" + iRow] || "on" == ajax_error_count["tipo_" + iRow] || "on" == ajax_error_count["ddd_" + iRow] || "on" == ajax_error_count["numero_" + iRow] || "on" == ajax_error_count["obs_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_ordem_" + iRow))
        document.getElementById("hidden_field_data_ordem_" + iRow).className = "scFormErrorLine";
      ...
      if (document.getElementById("hidden_field_data_ddd_" + iRow))
        document.getElementById("hidden_field_data_ddd_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["idcliente_" + iRow] && "off" == ajax_error_count["ordem_" + iRow] && "off" == ajax_error_count["tipo_" + iRow] && "off" == ajax_error_count["ddd_" + iRow] && "off" == ajax_error_count["numero_" + iRow] && "off" == ajax_error_count["obs_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["idcliente_" + iRow] = "off";
        ajax_error_count["ordem_" + iRow] = "off";
        ajax_error_count["tipo_" + iRow] = "off";
        ajax_error_count["ddd_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_ordem_" + iRow))
        document.getElementById("hidden_field_data_ordem_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_tipo_" + iRow))
        document.getElementById("hidden_field_data_tipo_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_ddd_" + iRow))
        document.getElementById("hidden_field_data_ddd_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_numero_" + iRow))
