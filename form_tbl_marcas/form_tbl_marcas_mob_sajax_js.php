  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_marcas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_tbl_marcas_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_marcas_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbl_marcas_mob_validate_id_cb);
  } // do_ajax_form_tbl_marcas_mob_validate_id

  function do_ajax_form_tbl_marcas_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_marcas_mob_validate_id_cb

  // ---------- Validate marca
  function do_ajax_form_tbl_marcas_mob_validate_marca()
  {
    var nomeCampo_marca = "marca";
    var var_marca = scAjaxGetFieldText(nomeCampo_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_marcas_mob_validate_marca(var_marca, var_script_case_init, do_ajax_form_tbl_marcas_mob_validate_marca_cb);
  } // do_ajax_form_tbl_marcas_mob_validate_marca

  function do_ajax_form_tbl_marcas_mob_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "marca";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_marcas_mob_validate_marca_cb

  // ---------- Validate md_tbl_modelos
  function do_ajax_form_tbl_marcas_mob_validate_md_tbl_modelos()
  {
    var nomeCampo_md_tbl_modelos = "md_tbl_modelos";
    var var_md_tbl_modelos = scAjaxGetFieldText(nomeCampo_md_tbl_modelos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_marcas_mob_validate_md_tbl_modelos(var_md_tbl_modelos, var_script_case_init, do_ajax_form_tbl_marcas_mob_validate_md_tbl_modelos_cb);
  } // do_ajax_form_tbl_marcas_mob_validate_md_tbl_modelos

  function do_ajax_form_tbl_marcas_mob_validate_md_tbl_modelos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "md_tbl_modelos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_marcas_mob_validate_md_tbl_modelos_cb
  // ---------- Form
  function do_ajax_form_tbl_marcas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_marcas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_marcas_mob_submit_form(var_id, var_marca, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_marcas_mob_submit_form_cb);
  } // do_ajax_form_tbl_marcas_mob_submit_form

  function do_ajax_form_tbl_marcas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("md_tbl_modelos");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_tbl_marcas_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_tbl_modelos"] = "off";

  function do_ajax_form_tbl_marcas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tbl_modelos"] = "on";
    x_ajax_form_tbl_marcas_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_marcas_mob_navigate_form_cb);
  } // do_ajax_form_tbl_marcas_mob_navigate_form

  function do_ajax_form_tbl_marcas_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tbl_marcas_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
    ...
    document.getElementById('nmsc_iframe_liga_form_tbl_modelos').contentWindow.nm_move('apl_detalhe', true, '380px');
    document.getElementById('nmsc_iframe_liga_form_tbl_modelos').style.height = "380px";
    document.getElementById('nmsc_iframe_liga_form_tbl_modelos').style.display = "none";
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
    scAjaxMessage();
...
{
?>
    do_ajax_form_tbl_marcas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tbl_marcas_mob_navigate_form_cb
  function sc_hide_form_tbl_marcas_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tbl_modelos"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "md_tbl_modelos";
  ...
  var ajax_error_list = {
    ...
    "md_tbl_modelos": {"label": "Modelos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
