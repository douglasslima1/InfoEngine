  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_marcas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_tbl_marcas_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_marcas_validate_id(var_id, var_script_case_init, do_ajax_form_tbl_marcas_validate_id_cb);
  } // do_ajax_form_tbl_marcas_validate_id

  function do_ajax_form_tbl_marcas_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_marcas_validate_id_cb

  // ---------- Validate marca
  function do_ajax_form_tbl_marcas_validate_marca()
  {
    var nomeCampo_marca = "marca";
    var var_marca = scAjaxGetFieldText(nomeCampo_marca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_marcas_validate_marca(var_marca, var_script_case_init, do_ajax_form_tbl_marcas_validate_marca_cb);
  } // do_ajax_form_tbl_marcas_validate_marca

  function do_ajax_form_tbl_marcas_validate_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "marca";
    scEventControl_onBlur(sFieldValid);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_marcas_validate_marca_cb

  // ---------- Validate md_tbl_modelos
  function do_ajax_form_tbl_marcas_validate_md_tbl_modelos()
  {
    var nomeCampo_md_tbl_modelos = "md_tbl_modelos";
    var var_md_tbl_modelos = scAjaxGetFieldText(nomeCampo_md_tbl_modelos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_marcas_validate_md_tbl_modelos(var_md_tbl_modelos, var_script_case_init, do_ajax_form_tbl_marcas_validate_md_tbl_modelos_cb);
  } // do_ajax_form_tbl_marcas_validate_md_tbl_modelos

  function do_ajax_form_tbl_marcas_validate_md_tbl_modelos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_marcas_validate_md_tbl_modelos_cb
  // ---------- Form
  function do_ajax_form_tbl_marcas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_marcas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_marcas_submit_form(var_id, var_marca, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_marcas_submit_form_cb);
  } // do_ajax_form_tbl_marcas_submit_form

  function do_ajax_form_tbl_marcas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tbl_marcas_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_tbl_modelos"] = "off";

  function do_ajax_form_tbl_marcas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_tbl_marcas_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_marcas_navigate_form_cb);
  } // do_ajax_form_tbl_marcas_navigate_form

  function do_ajax_form_tbl_marcas_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_tbl_marcas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_marcas_navigate_form_cb
  function sc_hide_form_tbl_marcas_form()
  {
