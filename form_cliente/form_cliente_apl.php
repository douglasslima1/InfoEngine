...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_cli_end']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_cli_end']['total']);
              $_SESSION['sc_session'][$script_case_init]['form_cli_tel']['reg_start'] = "";
              unset($_SESSION['sc_session'][$script_case_init]['form_cli_tel']['total']);
              $_SESSION['sc_session'][$script_case_init]['form_cli_car']['reg_start'] = "";
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cliente']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cliente']['label'] = "Cliente";
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cli_end') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cli_end') . "/form_cli_end_apl.php");
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cli_tel') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cli_tel') . "/form_cli_tel_apl.php");
          ...
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cli_car') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_cli_car') . "/form_cli_car_apl.php");
...
//---------------------------------------------------------
    ...
    function ValidateField_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['php_cmp_required']['tipo'] == "on")
        { 
          $Campos_Falta[] = "Tipo" ; 
      ...
      if ($this->tipo != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipo']) && !in_array($this->tipo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipo']))
          {
    ...
    function ValidateField_cpfcnpj(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['php_cmp_required']['cpfcnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['php_cmp_required']['cpfcnpj'] == "on") 
          { 
              $Campos_Falta[] = "CPF" ; 
              if (!isset($Campos_Erros['cpfcnpj']))
              {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['php_cmp_required']['nome'] == "on")) 
      { 
          if ($this->nome == "")  
          { 
              $Campos_Falta[] =  "Nome" ; 
    ...
    function ValidateField_ativo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->ativo != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_ativo']) && !in_array($this->ativo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_ativo']))
          {
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_cliente_pack_protect_string($this->nmgp_dados_form['id']);
...
$aLookup[] = array(form_cliente_pack_protect_string('F') => form_cliente_pack_protect_string("Física"));
$aLookup[] = array(form_cliente_pack_protect_string('J') => form_cliente_pack_protect_string("Jurídica"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipo'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipo'][] = 'J';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_cliente_pack_protect_string($v);
          }
...
$aLookup[] = array(form_cliente_pack_protect_string('R') => form_cliente_pack_protect_string("RG"));
$aLookup[] = array(form_cliente_pack_protect_string('M') => form_cliente_pack_protect_string("Municipal"));
$aLookup[] = array(form_cliente_pack_protect_string('F') => form_cliente_pack_protect_string("Federal"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipoinscricao'][] = 'R';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipoinscricao'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_tipoinscricao'][] = 'F';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipoinscricao']['valList'][$i] = form_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_cliente_pack_protect_string('1') => form_cliente_pack_protect_string("Sim"));
$aLookup[] = array(form_cliente_pack_protect_string('0') => form_cliente_pack_protect_string("Não"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_ativo'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['Lookup_ativo'][] = '0';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ativo']['valList'][$i] = form_cliente_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_cliente' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_cliente']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['sc_outra_jan']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['sc_outra_jan'])
   {
