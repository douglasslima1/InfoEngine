...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_tipo'][] = 'F'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_tipo'][] = 'J'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cpfcnpj_line" id="hidden_field_data_cpfcnpj" style="<?php echo $sStyleHidden_cpfcnpj; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cpfcnpj_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cpfcnpj_label"><span id="id_label_cpfcnpj"><?php echo $this->nm_new_label['cpfcnpj']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['cpfcnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['cpfcnpj'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nome_line" id="hidden_field_data_nome" style="<?php echo $sStyleHidden_nome; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nome_label"><span id="id_label_nome"><?php echo $this->nm_new_label['nome']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['nome'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_tipoinscricao'][] = 'R'; ?>
 <option value="M" <?php  if ($this->tipoinscricao == "M") { echo " selected" ;} ?>>Municipal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_tipoinscricao'][] = 'M'; ?>
 <option value="F" <?php  if ($this->tipoinscricao == "F") { echo " selected" ;} ?>>Federal</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_tipoinscricao'][] = 'F'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_ativo'][] = '1'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_ativo'][] = '0'; ?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cliente_mob_empty.htm' : $this->Ini->link_form_cli_end_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=280px');
?>
...
<?php $sStyleHidden_md_cli_end_dumb = ('' == $sStyleHidden_md_cli_end) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_md_cli_end_dumb" style="<?php echo $sStyleHidden_md_cli_end_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cliente_mob_empty.htm' : $this->Ini->link_form_cli_tel_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=280px');
?>
...
<?php $sStyleHidden_md_cli_tel2_dumb = ('' == $sStyleHidden_md_cli_tel2) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_md_cli_tel2_dumb" style="<?php echo $sStyleHidden_md_cli_tel2_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cliente_mob_empty.htm' : $this->Ini->link_form_cli_car_mob_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=280px');
?>
