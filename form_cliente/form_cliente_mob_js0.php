...
function sc_tipo_onchange()
{
   
}
function sc_tipo_onclick()
{
   if($('[name=tipo]')[1].checked)
{
	$('#id_label_cpfcnpj')[0].innerHTML = "CNPJ";
	$('#id_label_nome')[0].innerHTML = "Nome Fantasia";
	$('#id_label_nomeres')[0].innerHTML = "Razão Social";
	removerOptions();
	
	$('<option value="M">Municipal</option>').appendTo('#id_sc_field_tipoinscricao')[0];
	$('<option value="F">Federal</option>').appendTo('#id_sc_field_tipoinscricao')[0];
}
else
{
	$('#id_label_cpfcnpj')[0].innerHTML = "CPF";
	$('#id_label_nome')[0].innerHTML = "Nome";
	$('#id_label_nomeres')[0].innerHTML = "Nome Resumido";
	
	removerOptions();
	
	$('<option value="R">RG</option>').appendTo('#id_sc_field_tipoinscricao')[0];
}
