...
class grid_ordem_servico_totalizacao_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_ordem_servico_totalizacao_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ordem_servico_totalizacao_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ordem_servico_totalizacao_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ordem_servico_totalizacao_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " = " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " like '" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       if (in_array($nome_campo, $this->Out_dyn_search))
                       {
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = $NM_cmd;
                           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       }
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   if (in_array($nome_campo, $this->Out_dyn_search))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . $op_all . "'%" . $campo . "%'";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   }
               }
            break;
            case "DF":     // 
               ...
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome > " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome < " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome between " . $nm_aspas . $campo . $nm_aspas1 . " and " . $nm_aspas . $campo2 . $nm_aspas1;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               }
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = $nm_ini_lower . $nome . $nm_fim_lower . " in (" . $cond_str . ")";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
               }
            break;
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome IS NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'];
               }
            break;
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome IS NOT NULL ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'];
               }
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome = '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'];
               }
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               if (in_array($nome_campo, $this->Out_dyn_search))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd'][]  = " $nome <> '' ";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'][] = $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'];
               }
            break;
         }
      }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ordem_servico_totalizacao/grid_ordem_servico_totalizacao_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ordem_servico_totalizacao_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ordem_servico_totalizacao_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_datafechamento_cond#NMF#' + search_get_sel_txt('SC_datafechamento_cond') + '@NMF@';
  str_out += 'SC_datafechamento_dia#NMF#' + search_get_sel_txt('SC_datafechamento_dia') + '@NMF@';
  str_out += 'SC_datafechamento_mes#NMF#' + search_get_sel_txt('SC_datafechamento_mes') + '@NMF@';
  str_out += 'SC_datafechamento_ano#NMF#' + search_get_sel_txt('SC_datafechamento_ano') + '@NMF@';
  str_out += 'SC_datafechamento_input_2_dia#NMF#' + search_get_sel_txt('SC_datafechamento_input_2_dia') + '@NMF@';
  str_out += 'SC_datafechamento_input_2_mes#NMF#' + search_get_sel_txt('SC_datafechamento_input_2_mes') + '@NMF@';
  str_out += 'SC_datafechamento_input_2_ano#NMF#' + search_get_sel_txt('SC_datafechamento_input_2_ano') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Relatório de Ganhos</span></td>
...
<?php
   ...
   {
      global 
             $datafechamento_cond, $datafechamento, $datafechamento_dia, $datafechamento_mes, $datafechamento_ano, $datafechamento_input_2_dia, $datafechamento_input_2_mes, $datafechamento_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $datafechamento_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_dia']; 
          $datafechamento_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_mes']; 
          $datafechamento_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_ano']; 
          $datafechamento_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2_dia']; 
          $datafechamento_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2_mes']; 
          $datafechamento_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2_ano']; 
          $datafechamento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['NM_operador']; 
      } 
      if (!isset($datafechamento_cond) || empty($datafechamento_cond))
      {
         $datafechamento_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_datafechamento = (in_array($datafechamento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_datafechamento = ('bw' == $datafechamento_cond) ? $display_aberto : $display_fechado;

      if (!isset($datafechamento) || $datafechamento == "")
      {
          $datafechamento = "";
      }
      if (isset($datafechamento) && !empty($datafechamento))
      {
         $tmp_pos = strpos($datafechamento, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $datafechamento = substr($datafechamento, 0, $tmp_pos);
         }
      }
?>
 <?php
...
<?php
   if (is_file("grid_ordem_servico_totalizacao_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['datafechamento'])) ? $this->New_label['datafechamento'] : "Data Fechamento"; ?> <span class="scFilterRequiredOdd">*</span></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_datafechamento_cond" name="datafechamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_datafechamento'), this, 'datafechamento')">
       <OPTION value="eq" <?php if ("eq" == $datafechamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $datafechamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $datafechamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $datafechamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_datafechamento" <?php echo $str_hide_datafechamento?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['datafechamento'])) ? $this->New_label['datafechamento'] : "Data Fechamento";
 $nmgp_tab_label .= "datafechamento?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datafechamento_dia" name="datafechamento_dia" value="<?php echo NM_encode_input($datafechamento_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datafechamento_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datafechamento_mes" name="datafechamento_mes" value="<?php echo NM_encode_input($datafechamento_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datafechamento_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datafechamento_ano" name="datafechamento_ano" value="<?php echo NM_encode_input($datafechamento_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_datafechamento"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_datafechamento"  <?php echo $str_display_datafechamento; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datafechamento_input_2_dia" name="datafechamento_input_2_dia" value="<?php echo NM_encode_input($datafechamento_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datafechamento_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datafechamento_input_2_mes" name="datafechamento_input_2_mes" value="<?php echo NM_encode_input($datafechamento_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: false, enterTab: false}" onKeyUp="nm_tabula(this, 2, document.F1.datafechamento_cond.value)">
...
<?php
  ...
  {
?>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_datafechamento_input_2_ano" name="datafechamento_input_2_ano" value="<?php echo NM_encode_input($datafechamento_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['opc_psq'] && !$this->aba_iframe))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_datafechamento'), document.F1.datafechamento_cond, 'datafechamento');
   document.F1.datafechamento_dia.value = "";
   document.F1.datafechamento_mes.value = "";
   document.F1.datafechamento_ano.value = "";
   document.F1.datafechamento_input_2_dia.value = "";
   document.F1.datafechamento_input_2_mes.value = "";
   document.F1.datafechamento_input_2_ano.value = "";
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_datafechamento_dia').bind('change', function() {sc_grid_ordem_servico_totalizacao_valida_dia(this)});
    $('#SC_datafechamento_input_2_dia').bind('change', function() {sc_grid_ordem_servico_totalizacao_valida_dia(this)});
    $('#SC_datafechamento_input_2_mes').bind('change', function() {sc_grid_ordem_servico_totalizacao_valida_mes(this)});
    $('#SC_datafechamento_mes').bind('change', function() {sc_grid_ordem_servico_totalizacao_valida_mes(this)});
 }
 function sc_grid_ordem_servico_totalizacao_valida_dia(obj)
 {
 ...
 function sc_grid_ordem_servico_totalizacao_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "InfoEngine/grid_ordem_servico_totalizacao";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_ordem_servico_totalizacao/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields     = array();
      $tb_fields_esp = array();
      $tp_fields['SC_datafechamento_cond'] = 'cond';
      $tp_fields['SC_datafechamento_dia'] = 'text';
      $tp_fields['SC_datafechamento_mes'] = 'text';
      $tp_fields['SC_datafechamento_ano'] = 'text';
      $tp_fields['SC_datafechamento_input_2_dia'] = 'text';
      $tp_fields['SC_datafechamento_input_2_mes'] = 'text';
      $tp_fields['SC_datafechamento_input_2_ano'] = 'text';
      if (is_file($NM_patch))
      {
          $SC_V8    = false;
   ...
   {
      global $datafechamento_cond, $datafechamento, $datafechamento_dia, $datafechamento_mes, $datafechamento_ano, $datafechamento_input_2_dia, $datafechamento_input_2_mes, $datafechamento_input_2_ano, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $this->Out_dyn_search = array();
      $this->Out_dyn_search[] = "datafechamento";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cmd']  = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search_out_cond'] = array();
      $datafechamento_cond_salva = $datafechamento_cond; 
      if (!isset($datafechamento_input_2_dia) || $datafechamento_input_2_dia == "")
      {
          $datafechamento_input_2_dia = $datafechamento_dia;
      }
      if (!isset($datafechamento_input_2_mes) || $datafechamento_input_2_mes == "")
      {
          $datafechamento_input_2_mes = $datafechamento_mes;
      }
      if (!isset($datafechamento_input_2_ano) || $datafechamento_input_2_ano == "")
      {
          $datafechamento_input_2_ano = $datafechamento_ano;
      }
      if ($datafechamento_cond != "nu" && $datafechamento_cond != "nn" && $datafechamento_cond != "ep" && $datafechamento_cond != "ne")
      {
          if ($datafechamento_dia == "" && $datafechamento_mes == "" && $datafechamento_ano == "")
          {
              if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Data Fechamento : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          }
      }
      ...
      $I_Dyn = 0;
      $Dyn_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_dia'] = $datafechamento_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_mes'] = $datafechamento_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_ano'] = $datafechamento_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2_dia'] = $datafechamento_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2_mes'] = $datafechamento_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2_ano'] = $datafechamento_input_2_ano; 
      if (!empty($datafechamento_dia) || !empty($datafechamento_mes) || !empty($datafechamento_ano) || $datafechamento_cond_salva == "nu" || $datafechamento_cond_salva == "nn" || $datafechamento_cond_salva == "ep" || $datafechamento_cond_salva == "ne")
      {
          $Dyn_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['val'][0][] = "D:" . $datafechamento_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['val'][0][] = "M:" . $datafechamento_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['val'][0][] = "Y:" . $datafechamento_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['val'][1][] = "D:" . $datafechamento_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['val'][1][] = "M:" . $datafechamento_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['val'][1][] = "Y:" . $datafechamento_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_cond'] = $datafechamento_cond_salva; 
      if ($Dyn_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['cmp'] = "datafechamento"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['dyn_search'][$I_Dyn]['opc'] = $datafechamento_cond_salva; 
          $I_Dyn++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      if ($datafechamento_cond != "TP")
      {
          $datafechamento_cond = strtoupper($datafechamento_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $datafechamento_ano;
          $Dtxt .= $datafechamento_mes;
          $Dtxt .= $datafechamento_dia;
          $val[0]['ano'] = $datafechamento_ano;
          $val[0]['mes'] = $datafechamento_mes;
          $val[0]['dia'] = $datafechamento_dia;
          if ($datafechamento_cond == "BW")
          {
              $val[1]['ano'] = $datafechamento_input_2_ano;
              $val[1]['mes'] = $datafechamento_input_2_mes;
              $val[1]['dia'] = $datafechamento_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATE", $datafechamento_cond , "", "data");
          $datafechamento = $val[0];
          $this->cmp_formatado['datafechamento'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['datafechamento'], "YYYY-MM-DD");
          $this->cmp_formatado['datafechamento'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($datafechamento_cond == "BW")
          {
              $datafechamento_input_2     = $val[1];
              $this->cmp_formatado['datafechamento_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']['datafechamento_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['datafechamento_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['datafechamento_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $datafechamento_cond == "NU" || $datafechamento_cond == "NN"|| $datafechamento_cond == "EP"|| $datafechamento_cond == "NE")
          {
              $this->monta_condicao("dataFechamento", $datafechamento_cond, $datafechamento, $datafechamento_input_2, 'datafechamento', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['where_pesq_ant'] = $this->comando . $this->comando_fim;
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ordem_servico_totalizacao']['fast_search']);
