...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "datafechamento";$Nm_numeric[] = "sum(preco)";
...
?>
 ...
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br>
      ...
      <br><span id="id_hide_datafechamento"  <?php echo $str_hide_datafechamento?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <BR>
        <SPAN id="id_vis_datafechamento"  <?php echo $str_display_datafechamento; ?> class="scFilterFieldFontOdd">
