...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_cliente_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_cliente']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_cliente']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_cliente.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_cliente'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
