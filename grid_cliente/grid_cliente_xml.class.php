...
class grid_cliente_xml
{
   ...
   function NM_export_cpfcnpj()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cpfcnpj))
         {
             $this->cpfcnpj = sc_convert_encoding($this->cpfcnpj, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " cpfcnpj =\"" . $this->trata_dados($this->cpfcnpj) . "\"";
   }
   //----- id
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->nomeres))
         {
             $this->nomeres = sc_convert_encoding($this->nomeres, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " nomeres =\"" . $this->trata_dados($this->nomeres) . "\"";
   }
   //----- tipo
   function NM_export_tipo()
   {
         ...
         $this->xml_registro .= " tipo =\"" . $this->trata_dados($this->tipo) . "\"";
   }
   //----- tipoinscricao
   function NM_export_tipoinscricao()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->tipoinscricao))
         {
             $this->tipoinscricao = sc_convert_encoding($this->tipoinscricao, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " tipoinscricao =\"" . $this->trata_dados($this->tipoinscricao) . "\"";
   }
