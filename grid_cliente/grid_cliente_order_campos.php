...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["nome"] : "Nome";
   $tab_ger_campos['cpfcnpj'] = "on";
   $tab_def_campos['cpfcnpj'] = "cpfCnpj";
   $tab_converte["cpfCnpj"]   = "cpfcnpj";
   $tab_labels["cpfcnpj"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["cpfcnpj"])) ? $_SESSION['sc_session'][$sc_init]['grid_cliente']['labels']["cpfcnpj"] : "CPF/CNPJ";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cliente']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cliente']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cliente']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
