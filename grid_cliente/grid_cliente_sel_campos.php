<?php
   ...
   session_start();
    ...
    $Sel_Cmp = new grid_cliente_sel_cmp(); 
...
function Sel_cmp_init()
{
   ...
   $tab_ger_campos['nomeres'] = "on";
   $tab_ger_campos['tipo'] = "on";
   $tab_ger_campos['tipoinscricao'] = "on";
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['grid_cliente']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_cliente']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_cliente']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_cliente']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
