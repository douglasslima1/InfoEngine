<?php
   ...
   $Sel_Groupby = new chart_ordem_servico_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class chart_ordem_servico_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_tabular']);
       if ($sel_groupby == "sc_free_group_by")
       {
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['dataabertura'] = array('cmp' => "dataAbertura", 'ind' => 0);
           $tab_arr_groubby_cmp['id'] = array('cmp' => "id", 'ind' => 1);
           $tab_arr_groubby_sql[0] = array('cmp' => "dataAbertura", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "id", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_cmp'] = array();
           $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_sql'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_sql'][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
               }
           }
       }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       foreach ($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_display'] as $i_sum => $d_sum)
       {
           $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]['display'] = in_array($i_sum, $summ_fields);
       }
       $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_order'] = $summ_fields;
   }
?>
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['dataabertura']  = (isset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['labels']['dataabertura'])) ? $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['labels']['dataabertura'] : "Data Abertura";
   $arr_campos_free['id']  = (isset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['labels']['id'])) ? $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['labels']['id'] : "Id";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - ordem_servico</TITLE>
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_control'] as $l_field => $d_field)
    {
...
{
?>
   $("#sc_id_summ_available").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_display']) * 29 ?>px");
   $("#sc_id_summ_selected").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_display']) * 29 ?>px");
<?php
}
?>
  }
...
?>
 <tr id="sc_id_free_groupby">
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Groupby_hide']))
     {
...
<?php
        ...
        foreach ($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_cmp'] as $NM_cada_field => $resto)
        {
        ...
        if ($bSummaryPage)
        {
            ...
            foreach ($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['pivot_x_axys'] as $temp)
            {
                reset($aTmpGroupBy);
...
<?php
        ...
        {
           if (!isset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['SC_Gb_Free_cmp'][$NM_cada_field]))
           {
?>
...
<?php
        foreach ($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['chart_ordem_servico']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
