...
class chart_ordem_servico_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $conv_col;
   var $count_ger;
   var $sc_proc_quebra_dataabertura;
   var $count_dataabertura;
   var $sc_proc_quebra_id;
   var $count_id;

   //---- 
   function chart_ordem_servico_resumo($tipo = "")
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_ordem_servico']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['chart_ordem_servico']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['chart_ordem_servico']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_combination_type']        = 'line';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_combination_order_rule']  = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_combination_order_field'] = 'label';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys'][1] = 1;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_cmp']["dataabertura"] = 'dataabertura';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_cmp']["id"] = 'id';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_sql']["dataAbertura"] = 'asc';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_sql']["id"] = 'asc';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['comb_field_display_type'][1] = 'line';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_display_values'][1] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][1]['display'] = true;

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_order'][] = 1;
       }

      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['ajax_nav'])
      {
          $_SESSION['scriptcase']['saida_var'] = false; 
      }
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['where_resumo']);
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['array_graf_pdf'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['where_resumo'] = "";
      $this->inicializa_vars();
      $this->total->quebra_geral();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['tot_geral'] as $ind => $val)
      {
           if ($ind > 0)
           {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['contr_total_geral'] == "OK")
      {
          $this->array_total_dataabertura = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['arr_total']['dataabertura'];
          $this->array_total_id = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['arr_total']['id'];
      }
      else
      {
          $this->array_total_dataabertura = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['arr_total']['dataabertura'] = $this->array_total_dataabertura;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['arr_total']['id'] = $this->array_total_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $prep_field = array();
       $prep_field['dataabertura'] = "Data Abertura";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['labels'][''] = "Data Abertura"; 
       $prep_field['id'] = "Id";
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['labels'][''] = "Id"; 
       $Str_gb = "";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_control'] = array(
               'NM_Count' => array(
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['id']['alin'] = "''";
       $Arr_parms['id']['link'] = "N";
       $Arr_parms['dataabertura']['alin'] = "''";
       $Arr_parms['dataabertura']['link'] = "N";
       $Arr_parms['dataabertura']['fill'] = "true";
       $Arr_parms['dataabertura']['order'] = "value";
       $Arr_parms['id']['fill'] = "true";
       $Arr_parms['id']['order'] = "value";
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['dataabertura'] = array(0 => 'dataabertura', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_tabular'] = $this->comp_tabular;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_sort'] = '';
       }
       if (isset($_POST['change_sort']) && 'Y' == $_POST['change_sort'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_col']  = $_POST['sort_col'];
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_tabular'];
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '0' => array(
               ...
               'show_sub' => false,
               'subtitle' => "",
               'label_x'  => $this->getChartText("Data Abertura"),
               'label_y'  => $this->getChartText("" .  $this->Ini->Nm_lang['lang_othr_rows'] . ""),
               'format'   => $this->formatChartValue(0),
           ),
           ),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['summarizing_fields_order'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_ordem_servico_' . session_id() . '_C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__.xml' : '',
                               'xml'         => 'sc_chart_ordem_servico_' . session_id() . '_C_' . $i_index_group . '_' . $s_index_comb . '.xml',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['comb_table_def']  = array();
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_chart_ordem_servico_' . session_id() . '_' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_chart_ordem_servico_' . session_id() . '_' . implode('_', array_merge(array($group, $i_total), $param)) . '.xml';
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['arr_export']['data']  = $this->build_data;
           return;
       }
       ...
       foreach ($this->build_data as $lines)
       {
           ...
           foreach ($lines as $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['embutida'])
                   {
   ...
   function resumo_init()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_ordem_servico']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_ordem_servico']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_ordem_servico']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_ordem_servico']) . "_";
               } 
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_ordem_servico_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['print_all'];
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] = "print";
      ...
      $this->total   = new chart_ordem_servico_total($this->Ini->sc_page);
   ...
   function totaliza()
   {
      $this->total->resumo_sc_free_group_by("res", $this->array_total_dataabertura, $this->array_total_id);
      ksort($this->array_total_dataabertura);
...
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
      ...
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - ordem_servico</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_ordem_servico_ajax.js\"></script>\r\n");
      include_once($this->Ini->Apl_grafico);
      $sFusionChartModule = chart_ordem_servico_grafico::getChartModule();
      if ('' == $sFusionChartModule)
      {
          $sFusionChartModule = chart_ordem_servico_grafico::getChartModule('Bar');
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_ordem_servico_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_ordem_servico_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_ordem_servico_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_ordem_servico/chart_ordem_servico_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_ordem_servico/chart_ordem_servico_config_print.php?nm_opc=resumo&nm_cor=AM&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
         ...
         if (is_file("chart_ordem_servico_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("chart_ordem_servico_help.txt"); 
   ...
   $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsort_on", "scShowSort('#chart_sort_on_top')", "scShowSort('#chart_sort_on_top')", "chart_sort_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "");
      ...
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid) && !$this->NM_res_sem_reg)
      {
            ...
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_line", "scChangeChartTypeButton('line')", "scChangeChartTypeButton('line')", "chart_line_top", "", "", "display: none;", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "\$('#chart_line_top').css('display', 'none');\$('#chart_line_on_top').css('display', 'inline-block');", "", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $Cod_Btn = nmButtonOutput($this->arr_buttons, "bchart_line_on", "scChangeChartTypeButton('line')", "scChangeChartTypeButton('line')", "chart_line_on_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "if (tp_graf_atual != 'line'){\$('#chart_line_on_top').css('display', 'none');\$('#chart_line_top').css('display', 'inline-block');}", "", "");
            $nm_saida->saida("     $Cod_Btn\r\n");
            $NM_btn = true;
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_ordem_servico_config_pivot.php?nome_apl=chart_ordem_servico&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "chart_ordem_servico/chart_ordem_servico_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_ordem_servico_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_ordem_servico@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      $nm_saida->saida("  if (\"pdf\" == x)\r\n");
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "chart_ordem_servico/chart_ordem_servico_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_ordem_servico_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_ordem_servico/chart_ordem_servico_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['print_all'])
       {
           $tp_quebra = "<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_charts']);
      ...
      if (!isset($this->progress_fp) || !$this->progress_fp)
      {
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
   $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<table><tr><td style=\"border-width:0;height:1px;padding:0\"><span style=\"display: none;\">&nbsp;</span><div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></td></tr></table>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_ordem_servico_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['cond_pesq'], 0, $trab_pos);
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . $this->Ini->Nm_lang['lang_othr_chart_titl'] . " - ordem_servico</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_dataabertura, $quebra_id, $quebra_dataabertura_orig, $quebra_id_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT id, dataAbertura, dataFechamento, preco from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT id, dataAbertura, dataFechamento, preco from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_ordem_servico']['where_pesq']; 
     $temp = "";
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->dataabertura = $rs_res->fields[1] ;  
            $this->datafechamento = $rs_res->fields[2] ;  
            $this->preco = $rs_res->fields[3] ;  
            $this->preco =  str_replace(",", ".", $this->preco);
            $this->dataabertura_orig = $this->dataabertura;
            $this->id_orig = $this->id;
            $conteudo_x = $this->dataabertura;
            nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD");
            if (is_numeric($conteudo_x) && $conteudo_x > 0) 
            { 
                $this->nm_data->SetaData($this->dataabertura, "YYYY-MM-DD");
                $this->dataabertura = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "ddmmaaaa"));
            } 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->dataabertura, $this->id, $this->dataabertura_orig,  $this->id_orig);
            }
   }
//
