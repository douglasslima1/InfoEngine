...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["InfoEngine_____chart_ordem_servico"]))
   {
      unset($_SESSION['session_sec_aplicacao']["InfoEngine_____chart_ordem_servico"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_ordem_servico</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_ordem_servico']['embutida_filho'] as $ind => $sc_init)
          {
