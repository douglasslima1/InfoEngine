...
<?php
include_once("form_ordem_servico_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_ordem_servico_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['recarga'];
}
?>
...
<?php
 include_once("form_ordem_servico_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_ordem_servico'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_ordem_servico'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['btn_nota_servico'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "btn_nota_servico", "sc_btn_btn_nota_servico()", "sc_btn_btn_nota_servico()", "sc_btn_nota_servico_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } 
?> 
<?php $sStyleHidden_dataabertura_dumb = ('' == $sStyleHidden_dataabertura) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_dataabertura_dumb" style="<?php echo $sStyleHidden_dataabertura_dumb; ?>"></TD>
<?php $sStyleHidden_datafechamento_dumb = ('' == $sStyleHidden_datafechamento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_datafechamento_dumb" style="<?php echo $sStyleHidden_datafechamento_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
<?php
...
<?php } 
?> 
<?php $sStyleHidden_idcli_car_dumb = ('' == $sStyleHidden_idcli_car) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idcli_car_dumb" style="<?php echo $sStyleHidden_idcli_car_dumb; ?>"></TD>
<?php $sStyleHidden_preco_dumb = ('' == $sStyleHidden_preco) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_preco_dumb" style="<?php echo $sStyleHidden_preco_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_ordem_servico_empty.htm' : $this->Ini->link_form_servico_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page . '&script_case_session=' . session_id() . '&script_case_detail=Y&sc_ifr_height=280px');
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_ordem_servico");
 parent.scAjaxDetailHeight("form_ordem_servico", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
