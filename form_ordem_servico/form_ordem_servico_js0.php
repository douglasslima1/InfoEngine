...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_ordem_servico"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_btn_nota_servico_idos = <?php echo $JsonVarLiga->encode($this->nmgp_dados_form['id']); ?>;
function sc_btn_btn_nota_servico()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_nota_servico(); }, 500);
      return;
    }
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_nota_servico_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "idos?#?' + var_btn_btn_nota_servico_idos + '?@?"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_nota_servico');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ordem_servico']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("dataabertura=disabled;preco=disabled", "");
