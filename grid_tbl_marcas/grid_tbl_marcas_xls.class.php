...
class grid_tbl_marcas_xls
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= "_grid_tbl_marcas";
      $this->Arquivo   .= ".xls";
      $this->Tit_doc    = "grid_tbl_marcas.xls";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['order_grid'];
   ...
   function NM_export_marca()
   {
         ...
         if (!NM_is_utf8($this->marca))
         {
             $this->marca = sc_convert_encoding($this->marca, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($this->calc_cell($this->Xls_col) . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($this->calc_cell($this->Xls_col) . $this->Xls_row, $this->marca, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tbl_marcas'][$path_doc_md5][1] = $this->Tit_doc;
?>
