...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["InfoEngine_____grid_tbl_marcas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["InfoEngine_____grid_tbl_marcas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tbl_marcas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tbl_marcas']['embutida_filho'] as $ind => $sc_init)
          {
