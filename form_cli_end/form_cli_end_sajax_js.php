  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cli_end" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idcliente_
  function do_ajax_form_cli_end_validate_idcliente_(iNumLinha)
  {
    var nomeCampo_idcliente_ = "idcliente_" + iNumLinha;
    var var_idcliente_ = scAjaxGetFieldText(nomeCampo_idcliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_idcliente_(var_idcliente_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_idcliente__cb);
  } // do_ajax_form_cli_end_validate_idcliente_

  function do_ajax_form_cli_end_validate_idcliente__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_idcliente__cb

  // ---------- Validate tipo_
  function do_ajax_form_cli_end_validate_tipo_(iNumLinha)
  {
    var nomeCampo_tipo_ = "tipo_" + iNumLinha;
    var var_tipo_ = scAjaxGetFieldSelect(nomeCampo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_tipo_(var_tipo_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_tipo__cb);
  } // do_ajax_form_cli_end_validate_tipo_

  function do_ajax_form_cli_end_validate_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_tipo__cb

  // ---------- Validate cep_
  function do_ajax_form_cli_end_validate_cep_(iNumLinha)
  {
    var nomeCampo_cep_ = "cep_" + iNumLinha;
    var var_cep_ = scAjaxGetFieldText(nomeCampo_cep_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_cep_(var_cep_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_cep__cb);
  } // do_ajax_form_cli_end_validate_cep_

  function do_ajax_form_cli_end_validate_cep__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_cep__cb

  // ---------- Validate endereco_
  function do_ajax_form_cli_end_validate_endereco_(iNumLinha)
  {
    var nomeCampo_endereco_ = "endereco_" + iNumLinha;
    var var_endereco_ = scAjaxGetFieldText(nomeCampo_endereco_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_endereco_(var_endereco_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_endereco__cb);
  } // do_ajax_form_cli_end_validate_endereco_

  function do_ajax_form_cli_end_validate_endereco__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_endereco__cb

  // ---------- Validate numero_
  function do_ajax_form_cli_end_validate_numero_(iNumLinha)
  {
    var nomeCampo_numero_ = "numero_" + iNumLinha;
    var var_numero_ = scAjaxGetFieldText(nomeCampo_numero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_numero_(var_numero_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_numero__cb);
  } // do_ajax_form_cli_end_validate_numero_

  function do_ajax_form_cli_end_validate_numero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_numero__cb

  // ---------- Validate complemento_
  function do_ajax_form_cli_end_validate_complemento_(iNumLinha)
  {
    var nomeCampo_complemento_ = "complemento_" + iNumLinha;
    var var_complemento_ = scAjaxGetFieldText(nomeCampo_complemento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_complemento_(var_complemento_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_complemento__cb);
  } // do_ajax_form_cli_end_validate_complemento_

  function do_ajax_form_cli_end_validate_complemento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_complemento__cb

  // ---------- Validate bairro_
  function do_ajax_form_cli_end_validate_bairro_(iNumLinha)
  {
    var nomeCampo_bairro_ = "bairro_" + iNumLinha;
    var var_bairro_ = scAjaxGetFieldText(nomeCampo_bairro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_bairro_(var_bairro_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_bairro__cb);
  } // do_ajax_form_cli_end_validate_bairro_

  function do_ajax_form_cli_end_validate_bairro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_bairro__cb

  // ---------- Validate municipio_
  function do_ajax_form_cli_end_validate_municipio_(iNumLinha)
  {
    var nomeCampo_municipio_ = "municipio_" + iNumLinha;
    var var_municipio_ = scAjaxGetFieldText(nomeCampo_municipio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_municipio_(var_municipio_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_municipio__cb);
  } // do_ajax_form_cli_end_validate_municipio_

  function do_ajax_form_cli_end_validate_municipio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "municipio_" + iLineNumber;
    }
    else
    {
      sFieldValid = "municipio_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "municipio_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "municipio_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_municipio__cb

  // ---------- Validate idestado_
  function do_ajax_form_cli_end_validate_idestado_(iNumLinha)
  {
    var nomeCampo_idestado_ = "idestado_" + iNumLinha;
    var var_idestado_ = scAjaxGetFieldSelect(nomeCampo_idestado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_idestado_(var_idestado_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_idestado__cb);
  } // do_ajax_form_cli_end_validate_idestado_

  function do_ajax_form_cli_end_validate_idestado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idestado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idestado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idestado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idestado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_idestado__cb

  // ---------- Validate id_
  function do_ajax_form_cli_end_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_cli_end_validate_id__cb);
  } // do_ajax_form_cli_end_validate_id_

  function do_ajax_form_cli_end_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cli_end_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cli_end_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cli_end_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cli_end_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cli_end_add_new_line_cb);
  } // do_ajax_form_cli_end_add_new_line

  function do_ajax_form_cli_end_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    ...
    nm_field_disabled("endereco_=disabled;bairro_=disabled;municipio_=disabled;idestado_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_cli_end_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cli_end_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cli_end_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cli_end_backup_line_cb);
  } // do_ajax_form_cli_end_backup_line

  function do_ajax_form_cli_end_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_cli_end_backup_line_cb

  function do_ajax_form_cli_end_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cli_end_cancel_insert

  function do_ajax_form_cli_end_cancel_update(iSeqVert)
  {
    do_ajax_form_cli_end_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cli_end_cancel_update

  function do_ajax_form_cli_end_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cli_end_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cli_end_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_cli_end_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cli_end_table_refresh_cb);
  } //  do_ajax_form_cli_end_table_refresh

  function do_ajax_form_cli_end_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_cli_end_table_refresh_cb
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cli_end_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cli_end_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idcliente_ = scAjaxGetFieldText("idcliente_" + iNumLinha);
    ...
    var var_municipio_ = scAjaxGetFieldText("municipio_" + iNumLinha);
    var var_idestado_ = scAjaxGetFieldSelect("idestado_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cli_end_submit_form(var_idcliente_, var_tipo_, var_cep_, var_endereco_, var_numero_, var_complemento_, var_bairro_, var_municipio_, var_idestado_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cli_end_submit_form_cb);
  } // do_ajax_form_cli_end_submit_form

  function do_ajax_form_cli_end_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("municipio_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idestado_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_cli_end_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_cli_end_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cli_end_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("municipio_" + iNavForm);
      scAjaxHideErrorDisplay("idestado_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cli_end_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cli_end_navigate_form_cb);
  } // do_ajax_form_cli_end_navigate_form

  function do_ajax_form_cli_end_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_cli_end_navigate_form_cb
  function sc_hide_form_cli_end_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_cli_end_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "municipio_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idestado_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["municipio_" + iNumLinha] = {"label": "Municipio<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idestado_" + iNumLinha] = {"label": "Id Estado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["municipio_"][iNumLinha] = "municipio_" + iNumLinha;
    ajax_field_mult["idestado_"][iNumLinha] = "idestado_" + iNumLinha;
    ...
    ajax_field_id["municipio_" + iNumLinha] = new Array("hidden_field_label_municipio_", "hidden_field_data_municipio_" + iNumLinha);
    ajax_field_id["idestado_" + iNumLinha] = new Array("hidden_field_label_idestado_", "hidden_field_data_idestado_" + iNumLinha);
    ...
    ajax_error_count["municipio_" + iNumLinha] = "off";
    ajax_error_count["idestado_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["municipio_" + iNumLinha] = "on";
    ajax_read_only["idestado_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["municipio_" + iNumLinha] = null;
    ajax_error_list["idestado_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["municipio_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["municipio_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["municipio_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["municipio_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["municipio_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idestado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idestado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idestado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idestado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idestado_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcliente_'])) ? $this->nmgp_cmp_readonly['idcliente_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['bairro_'])) ? $this->nmgp_cmp_readonly['bairro_'] : 'on';
?>
    scAjaxFieldRead("bairro_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['municipio_'])) ? $this->nmgp_cmp_readonly['municipio_'] : 'on';
?>
    scAjaxFieldRead("municipio_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idestado_'])) ? $this->nmgp_cmp_readonly['idestado_'] : 'on';
?>
    scAjaxFieldRead("idestado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("municipio_" + iSeq, "on");
    scAjaxFieldRead("idestado_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idcliente_" + iRow] || "on" == ajax_error_count["tipo_" + iRow] || "on" == ajax_error_count["cep_" + iRow] || "on" == ajax_error_count["endereco_" + iRow] || "on" == ajax_error_count["numero_" + iRow] || "on" == ajax_error_count["complemento_" + iRow] || "on" == ajax_error_count["bairro_" + iRow] || "on" == ajax_error_count["municipio_" + iRow] || "on" == ajax_error_count["idestado_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_cep_" + iRow))
        document.getElementById("hidden_field_data_cep_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_endereco_" + iRow))
        document.getElementById("hidden_field_data_endereco_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_numero_" + iRow))
        document.getElementById("hidden_field_data_numero_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_complemento_" + iRow))
        document.getElementById("hidden_field_data_complemento_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_bairro_" + iRow))
        document.getElementById("hidden_field_data_bairro_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_municipio_" + iRow))
        document.getElementById("hidden_field_data_municipio_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_idestado_" + iRow))
        document.getElementById("hidden_field_data_idestado_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idcliente_" + iRow] && "off" == ajax_error_count["tipo_" + iRow] && "off" == ajax_error_count["cep_" + iRow] && "off" == ajax_error_count["endereco_" + iRow] && "off" == ajax_error_count["numero_" + iRow] && "off" == ajax_error_count["complemento_" + iRow] && "off" == ajax_error_count["bairro_" + iRow] && "off" == ajax_error_count["municipio_" + iRow] && "off" == ajax_error_count["idestado_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["municipio_" + iRow] = "off";
        ajax_error_count["idestado_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_cep_" + iRow))
        document.getElementById("hidden_field_data_cep_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_endereco_" + iRow))
        document.getElementById("hidden_field_data_endereco_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_numero_" + iRow))
        document.getElementById("hidden_field_data_numero_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_complemento_" + iRow))
        document.getElementById("hidden_field_data_complemento_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_bairro_" + iRow))
        document.getElementById("hidden_field_data_bairro_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_municipio_" + iRow))
        document.getElementById("hidden_field_data_municipio_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_idestado_" + iRow))
        document.getElementById("hidden_field_data_idestado_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_id_" + iRow))
