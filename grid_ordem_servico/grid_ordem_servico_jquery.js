...
function ajax_navigate(opc, parm)
{
    ...
    $.ajax({
      ...
      success: function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_ordem_servico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_ordem_servico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_ordem_servico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_ordem_servico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_ordem_servico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_ordem_servico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_ordem_servico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_ordem_servico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_ordem_servico').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_ordem_servico').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_ordem_servico').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_ordem_servico').style.width  = '0px';
        if (oResp["redirInfo"]) {
           nmAjaxRedir(oResp);
        }
        if (oResp["setValue"]) {
