  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_servico" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate descricao_
  function do_ajax_form_servico_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servico_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_form_servico_validate_descricao__cb);
  } // do_ajax_form_servico_validate_descricao_

  function do_ajax_form_servico_validate_descricao__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servico_validate_descricao__cb

  // ---------- Validate data_
  function do_ajax_form_servico_validate_data_(iNumLinha)
  {
    var nomeCampo_data_ = "data_" + iNumLinha;
    var var_data_ = scAjaxGetFieldHidden(nomeCampo_data_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servico_validate_data_(var_data_, iNumLinha, var_script_case_init, do_ajax_form_servico_validate_data__cb);
  } // do_ajax_form_servico_validate_data_

  function do_ajax_form_servico_validate_data__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servico_validate_data__cb

  // ---------- Validate preco_
  function do_ajax_form_servico_validate_preco_(iNumLinha)
  {
    var nomeCampo_preco_ = "preco_" + iNumLinha;
    var var_preco_ = scAjaxGetFieldText(nomeCampo_preco_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servico_validate_preco_(var_preco_, iNumLinha, var_script_case_init, do_ajax_form_servico_validate_preco__cb);
  } // do_ajax_form_servico_validate_preco_

  function do_ajax_form_servico_validate_preco__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "preco_" + iLineNumber;
    }
    else
    {
      sFieldValid = "preco_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "preco_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "preco_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servico_validate_preco__cb

  // ---------- Validate obs_
  function do_ajax_form_servico_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servico_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_servico_validate_obs__cb);
  } // do_ajax_form_servico_validate_obs_

  function do_ajax_form_servico_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servico_validate_obs__cb

  // ---------- Validate id_
  function do_ajax_form_servico_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servico_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_servico_validate_id__cb);
  } // do_ajax_form_servico_validate_id_

  function do_ajax_form_servico_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_servico_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_servico_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_servico_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_servico_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_servico_add_new_line_cb);
  } // do_ajax_form_servico_add_new_line

  function do_ajax_form_servico_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    ...
    nm_field_disabled("data_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_servico_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_servico_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_servico_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_servico_backup_line_cb);
  } // do_ajax_form_servico_backup_line

  function do_ajax_form_servico_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_servico_backup_line_cb

  function do_ajax_form_servico_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_servico_cancel_insert

  function do_ajax_form_servico_cancel_update(iSeqVert)
  {
    do_ajax_form_servico_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_servico_cancel_update

  function do_ajax_form_servico_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_servico_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_servico_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_servico_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servico_table_refresh_cb);
  } //  do_ajax_form_servico_table_refresh

  function do_ajax_form_servico_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_insert_open = false;
  } // do_ajax_form_servico_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_servico_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_servico_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_preco_ = scAjaxGetFieldText("preco_" + iNumLinha);
...
?>
    x_ajax_form_servico_submit_form(var_descricao_, var_data_, var_preco_, var_obs_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_servico_submit_form_cb);
  } // do_ajax_form_servico_submit_form

  function do_ajax_form_servico_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("preco_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_servico_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_servico_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_servico_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("preco_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_servico_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_servico_navigate_form_cb);
  } // do_ajax_form_servico_navigate_form

  function do_ajax_form_servico_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
...
?>
  ...
  } // do_ajax_form_servico_navigate_form_cb
  function sc_hide_form_servico_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_servico_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "preco_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "obs_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["descricao_" + iNumLinha] = {"label": "Descricao<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["preco_" + iNumLinha] = {"label": "Preço<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["preco_"][iNumLinha] = "preco_" + iNumLinha;
    ...
    ajax_field_id["preco_" + iNumLinha] = new Array("hidden_field_label_preco_", "hidden_field_data_preco_" + iNumLinha);
    ...
    ajax_error_count["preco_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["preco_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["preco_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["preco_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["preco_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["preco_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["preco_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["preco_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["preco_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['preco_'])) ? $this->nmgp_cmp_readonly['preco_'] : 'off';
?>
    scAjaxFieldRead("preco_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("preco_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["data_" + iRow] || "on" == ajax_error_count["preco_" + iRow] || "on" == ajax_error_count["obs_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_descricao_" + iRow))
        document.getElementById("hidden_field_data_descricao_" + iRow).className = "scFormErrorLine";
      ...
      if (document.getElementById("hidden_field_data_preco_" + iRow))
        document.getElementById("hidden_field_data_preco_" + iRow).className = "scFormErrorLine";
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["data_" + iRow] && "off" == ajax_error_count["preco_" + iRow] && "off" == ajax_error_count["obs_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["descricao_" + iRow] = "off";
        ajax_error_count["data_" + iRow] = "off";
        ajax_error_count["preco_" + iRow] = "off";
      ...
      if (document.getElementById("hidden_field_data_descricao_" + iRow))
        document.getElementById("hidden_field_data_descricao_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_data_" + iRow))
        document.getElementById("hidden_field_data_data_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_preco_" + iRow))
        document.getElementById("hidden_field_data_preco_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_obs_" + iRow))
